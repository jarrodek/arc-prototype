(function() {
  ...
  */
  ...
  /**
   * Behavior for elements that use URL parser.
   *
   * @polymerBehavior ArcBehaviors.UrlParserBehavior
   */
  ...
  window.ArcBehaviors.UrlParserBehavior = {
    ...
    encodeQueryString: function(str) {
      return URLParser.encodeQueryString(str);
    },

    decodeQueryString: function(str) {
      return URLParser.decodeQueryString(str);
    }
  };
})();
